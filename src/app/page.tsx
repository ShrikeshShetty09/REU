      ...
      <section className="mx-auto max-w-6xl space-y-10 px-6" aria-labelledby="what-we-do">
        <div className="rounded-[40px] border border-white/60 bg-white/90 p-8 shadow-[0_30px_120px_-60px_rgba(122,2,142,.4)]">
          ...
          <p className="mt-4 text-base text-foreground/70">
            ...
            Systems such as DeltaV DCS and DeltaV MES, including validation, mapping and related lifecycle services.
          </p>
          <p className="mt-4 text-base text-foreground/70">
            Our core strength is a very strong back history of projects, quality-focused execution, timely delivery and robust
            site support. We manufacture and supply pressure reducing valves and systems, gas detectors, safety valves and
            laboratory gas purification systems for gases like nitrogen, hydrogen, helium and oxygen.
          </p>
          <p className="mt-4 text-base text-foreground/70">
            REU provides complete solutions for hydrogen and nitrogen banks with manifolds for truck mounted or stationary units,
            and executes complete laboratory and hospital piping (tubing) systems for utilities like gas, vacuum and water. Our
            teams also support automation projects across DeltaV DCS, MES platforms and validation cycles.
          </p>
        </div>
        <div className="grid gap-5 md:grid-cols-3">
          {[
            ...
            },
            {
              ...
              copy: "Direct access to designated partners for proposals, compliance clarifications, and project rollouts from Navi Mumbai.",
            },
          ].map((item) => (
        ...
        <div className="mx-auto max-w-6xl space-y-8 px-6">
          ...
          <div className="rounded-[40px] border border-white/60 bg-white/95 p-8 shadow-[0_30px_120px_-60px_rgba(122,2,142,.2)]">
            ...
            <div className="mt-8 flex justify-center">
              <Link
                href="/clients"
                className="rounded-full border border-[#a605c7]/40 px-6 py-2 text-sm font-semibold text-[#a605c7] hover:bg-[#a605c7] hover:text-white"
              >
                View more clients
              </Link>
            </div>
