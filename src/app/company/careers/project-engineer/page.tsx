          ...
          >
            ...
            <div className="rounded-3xl border border-[#f0d9ff] bg-white p-8 shadow-lg">
              ...
              <p className="text-sm text-foreground/70 mb-4">
                Ready to lead engineering projects? Apply now!
              </p>
              <button
                onClick={() => setShowApplicationForm(true)}
          ...
          >
            <div className="mb-6">
              ...
              <p className="text-sm text-foreground/70 mt-2">
                Join our engineering team and lead innovative projects
              </p>
            </div>
            ...
            <form className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  className="mt-1 w-full rounded-xl border border-gray-300 px-4 py-3 focus:border-[#a605c7] focus:outline-none"
                  rows={4}
                  placeholder="Tell us about your engineering experience and why you're interested in this position..."
                />
              </div>
